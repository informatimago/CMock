...
describe CMockGeneratorPluginCexception, "Verify CMockGeneratorPluginCexception Module" do
  ...
  it "add mock function declarations for functions without arguments" do
    ...
    expected = "#define Spruce_ExpectAndThrow(cmock_to_throw) Spruce_CMockExpectAndThrow(__FILE__, __LINE__, cmock_to_throw)\n"+
               "void Spruce_CMockExpectAndThrow(const char* cmock_file, UNITY_LINE_TYPE cmock_line, CEXCEPTION_T cmock_to_throw);\n"
  ...
  it "add mock function declarations for functions with arguments" do
    ...
    expected = "#define Spruce_ExpectAndThrow(Petunia, Lily, cmock_to_throw) Spruce_CMockExpectAndThrow(__FILE__, __LINE__, Petunia, Lily, cmock_to_throw)\n" +
               "void Spruce_CMockExpectAndThrow(const char* cmock_file, UNITY_LINE_TYPE cmock_line, const char* Petunia, uint32_t Lily, CEXCEPTION_T cmock_to_throw);\n"
    returned = @cmock_generator_plugin_cexception.mock_function_declarations(function)
    assert_equal(expected, returned)
  end
  ...
  it "add mock interfaces for functions without arguments" do
    ...
    expected = ["void Pear_CMockExpectAndThrow(const char* cmock_file, UNITY_LINE_TYPE cmock_line, CEXCEPTION_T cmock_to_throw)\n",
                "{\n",
                "mock_retval_0",
                "",
  ...
  it "add a mock interfaces for functions with arguments" do
    ...
    expected = ["void Pear_CMockExpectAndThrow(const char* cmock_file, UNITY_LINE_TYPE cmock_line, int blah, CEXCEPTION_T cmock_to_throw)\n",
                "{\n",
                "mock_retval_0",
                "mock_return_1",
                "  cmock_call_instance->ExceptionToThrow = cmock_to_throw;\n",
