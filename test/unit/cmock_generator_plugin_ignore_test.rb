...
describe CMockGeneratorPluginIgnore, "Verify CMockGeneratorPluginIgnore Module" do
  ...
  it "handle function declarations for functions that returns something" do
    ...
    expected = "#define Fungus_IgnoreAndReturn(cmock_retval) Fungus_CMockIgnoreAndReturn(__FILE__, __LINE__, cmock_retval)\n"+
               "void Fungus_CMockIgnoreAndReturn(const char* cmock_file, UNITY_LINE_TYPE cmock_line, const char* cmock_to_return);\n" +
  ...
  it "add a new mock interface for ignoring when function has return value" do
    ...
    expected = ["void Slime_CMockIgnoreAndReturn(const char* cmock_file, UNITY_LINE_TYPE cmock_line, int cmock_to_return)\n",
                "{\n",
                "mock_return_1",
